...
the Viterbi algorithm failed to predict the correct chords in most cases. Partly this
...
accuracy 0--5\%, but some songs had accuracy as high as 20--30\%.
...
model when faced with unseen information.
