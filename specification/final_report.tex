...
To compute the 12-dimensional chroma vectors, we used the Chroma Marsystem available in Marsyas. 
There are many ways to compute the chorma values...(Sondra is writing here).
